...
const getGrantConfig = require('@strapi/plugin-users-permissions/server/bootstrap/grant-config.js');
const usersPermissionsActions = require('@strapi/plugin-users-permissions/server/bootstrap/users-permissions-actions.js');
...
const initGrant = async pluginStore => {
  ...
  if (grantConfig.discord) {
    grantConfig.discord.scope = ['identify', 'email', 'guilds'];
  }
